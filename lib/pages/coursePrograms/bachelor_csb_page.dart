...
import 'package:cs_app/models/programs_model.dart';
import '../../services/course_service.dart';

class BachelorCsbPage extends StatefulWidget {
  const BachelorCsbPage({super.key});

  @override
  State<BachelorCsbPage> createState() => _BachelorCsbPageState();
}

class _BachelorCsbPageState extends State<BachelorCsbPage> {
