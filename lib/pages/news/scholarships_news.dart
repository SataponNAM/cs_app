...
import 'package:cs_app/models/news_model.dart';
import 'package:cs_app/pages/news/news_detail_page.dart';
import 'package:cs_app/services/news_service.dart';
import 'package:intl/intl.dart';

class ScholarshipsNews extends StatefulWidget {
  const ScholarshipsNews({super.key});

  @override
  State<ScholarshipsNews> createState() => _ScholarshipsNewsState();
}

class _ScholarshipsNewsState extends State<ScholarshipsNews> {
  ...
  void initState() {
    ...
    futureNews = httpService.fetchNews(strUrl: baseUrl).then((newsList) {
      return newsList.where((news) => news.type == "ข่าวทุนการศึกษา").toList();
    });
  }
